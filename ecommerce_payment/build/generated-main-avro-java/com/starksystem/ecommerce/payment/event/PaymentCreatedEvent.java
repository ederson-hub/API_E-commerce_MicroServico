 ...
 */
package com.starksystem.ecommerce.payment.event;
...
public class PaymentCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5292250235168360071L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PaymentCreatedEvent\",\"namespace\":\"com.starksystem.ecommerce.payment.event\",\"fields\":[{\"name\":\"checkoutCode\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"}]},{\"name\":\"paymentCode\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"}]}]}");
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: paymentCode = value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static com.starksystem.ecommerce.payment.event.PaymentCreatedEvent.Builder newBuilder() {
    return new com.starksystem.ecommerce.payment.event.PaymentCreatedEvent.Builder();
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static com.starksystem.ecommerce.payment.event.PaymentCreatedEvent.Builder newBuilder(com.starksystem.ecommerce.payment.event.PaymentCreatedEvent.Builder other) {
    if (other == null) {
      return new com.starksystem.ecommerce.payment.event.PaymentCreatedEvent.Builder();
    } else {
      return new com.starksystem.ecommerce.payment.event.PaymentCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static com.starksystem.ecommerce.payment.event.PaymentCreatedEvent.Builder newBuilder(com.starksystem.ecommerce.payment.event.PaymentCreatedEvent other) {
    if (other == null) {
      return new com.starksystem.ecommerce.payment.event.PaymentCreatedEvent.Builder();
    } else {
      return new com.starksystem.ecommerce.payment.event.PaymentCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.starksystem.ecommerce.payment.event.PaymentCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.starksystem.ecommerce.payment.event.PaymentCreatedEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.checkoutCode)) {
        this.checkoutCode = data().deepCopy(fields()[0].schema(), other.checkoutCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.starksystem.ecommerce.payment.event.PaymentCreatedEvent.Builder setCheckoutCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.starksystem.ecommerce.payment.event.PaymentCreatedEvent.Builder clearCheckoutCode() {
      checkoutCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.starksystem.ecommerce.payment.event.PaymentCreatedEvent.Builder setPaymentCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.starksystem.ecommerce.payment.event.PaymentCreatedEvent.Builder clearPaymentCode() {
      paymentCode = null;
    ...
    public PaymentCreatedEvent build() {
      try {
        ...
        record.paymentCode = fieldSetFlags()[1] ? this.paymentCode :  defaultValue(fields()[1]);
        return record;
